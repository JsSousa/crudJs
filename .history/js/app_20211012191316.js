...
const DrawDB = () => {
    ...
    if (arrayProducts === null) {
        ...
        arrayProducts.forEach(element, i => {
            ...
            <button type="button" id="btnEdit>${i+1}" data-bs-toggle="modal" data-bs-target="#exampleModal" name="btn-edit" class="btn btn-primary btn-sm"><i class="fa fa-edit text-ligth" aria-hidden="true"></i></button>
            <button type="button" id="btnDelete>${i+1}" name="btn-delete" class="btn btn-danger btn-sm"><i class="fa fa-trash text-ligth" aria-hidden="true"></i></button>
            </td>
        </tr>
