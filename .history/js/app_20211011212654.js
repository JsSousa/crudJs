...
const DrawDB = () => {
    ...
    if (arrayProducts === null) {
        ...
        arrayProducts.forEach(element => {
            ...
            <button type="button" id="btnEdit" name="btn-edit" class="btn btn-primary btn-sm"><i class="fa fa-edit text-ligth" aria-hidden="true"></i></button>
            <button type="button" id="btnDelete" name="btn-delete" class="btn btn-danger btn-sm"><i class="fa fa-trash text-ligth" aria-hidden="true"></i></button>
            </td>
        </tr>`
        });
    }
